...
def main2():
    ...
    #.05
    chosen_probability= .0006

    #number of repeating k-mers we want to remove
    repeating_mers_remove = 25
    ...
    average_histogram('abc_total_query_trial.csv', True, True,"average_accuracy_and_query_time_total_DBLP_levenshtein_trial2.png")
