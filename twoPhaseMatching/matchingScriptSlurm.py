...
'''
script to execute matchingProgram used for paper querying in slurm, executing the submit_theAdvisor_script.slurm will execute this script (matchingScriptSlurm.py) to run 
the two phase matching program
'''
